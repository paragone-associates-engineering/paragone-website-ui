        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', my: 2 }}>
              ...
              <Button startIcon={<AddIcon />} variant="outlined" onClick={handlePropertyAdd} sx={{ py: 1, bgcolor: 'white' }}>
                Add Property
              </Button>
            </Box>
            {formData.properties.map((property, index) => (
              <PropertyForm key={index} property={property} index={index} onUpdate={handlePropertyUpdate} onRemove={handlePropertyRemove} />
            ))}
          </Grid>
