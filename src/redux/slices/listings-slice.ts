...
import { API_BASE_URL, listingsApi } from '../../services/api';
...
export const fetchListings = createAsyncThunk('listings/fetchListings', async (params: ListingsQueryParams = {}, { rejectWithValue }) => {
  try {
    const apiFilters = transformFiltersToApiFormat(params);
    // console.log("params", params)
    // console.log("apiFilters", apiFilters)

    const response = await axios.post(`${API_BASE_URL}/listings/filter`, apiFilters, {
      params: {
        page: params.page || 1,
...
export const fetchFeaturedProperties = createAsyncThunk('listings/fetchFeaturedProperties', async (_, { rejectWithValue }) => {
  try {
...
export const fetchListingById = createAsyncThunk('listings/fetchListingById', async (id: string, { rejectWithValue }) => {
  try {
...
export const { setFilters, setCurrentPage, setPageSize, clearSelectedProperty, clearFeaturedProperties, clearRelatedProperties } =
