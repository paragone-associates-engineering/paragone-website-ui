...
const PropertyCard = ({ property }: { property: ApiProperty }) => {
  const chipStyles: Record<
    string,
    {
      label: string;
      bg: string;
      muiColor?: "primary" | "secondary" | "default";
    }
  > = {
  ...
  const bedrooms = property?.propertyDetails?.find(
    (detail) => detail.name === "bedrooms"
  )?.value;
  const bathrooms = property?.propertyDetails?.find(
    (detail) => detail.name === "bathrooms"
  )?.value;
        ...
        <Box sx={{ position: "relative" }}>
          ...
          >
            <Chip
              ...
              sx={{
                backgroundColor:
                  property?.listingType === "For Sale" ? "#46B0FD" : "#B032EB",
                color: "white",
                fontWeight: "bold",
                px: 1,
                py: 2,
        ...
        >
          <Box sx={{ mb: 20 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
              <LocationOnIcon
                sx={{ color: "primary.main", fontSize: 18, mr: 0.5 }}
              />
            ...
            <Grid
              container
              spacing={3}
              sx={{ mb: 2, "&:hover": { color: "text.primary" } }}
            >
              <Grid item xs={4}>
                <Box
                  sx={{
                ...
                >
                  <Box
                    component="img"
                    src="https://res.cloudinary.com/dv0mdoa6b/image/upload/v1742659739/fi_12907174_dvvx70.svg"
                    alt="squareft"
                    sx={{
                      p: 0.5,
                      width: 20,
              ...
              {property.propertyCategory !== "Land" && (
                <Grid item xs={4}>
                  ...
                  >
                    <Box
                      component="img"
                      src="https://res.cloudinary.com/dv0mdoa6b/image/upload/v1742659737/fi_2284001_zwywd0.svg"
                      alt="squareft"
                      sx={{
                        p: 0.5,
                        width: 20,
              ...
              {property.propertyCategory !== "Land" && (
                <Grid item xs={4}>
                  ...
                  >
                    <Box
                      component="img"
                      src="https://res.cloudinary.com/dv0mdoa6b/image/upload/v1742659735/fi_2425844_nnawgj.svg"
                      alt="squareft"
                      sx={{
                        p: 0.5,
                        width: 20,
