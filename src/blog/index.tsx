...
const Blog = () => {
  ...
  const { posts, totalPages, loading } = useSelector(
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Paragone Signature is a property management, investment, and development company, offering end-to-end services along the real estate value chain, from management to joint-venture investments."
        />
      </Helmet>
      <Box sx={{ width: "100vw" }}>
        <PageBanner
              ...
              <Grid item xs={12} md={6}>
                <AnimatedWrapper animation="slideLeft">
                  <Box
                    ...
                    src={
                      (heroBlog &&
                        typeof heroBlog !== "boolean" &&
                        heroBlog.images?.[0]) ||
                      "https://res.cloudinary.com/dv0mdoa6b/image/upload/v1741897467/luca-bravo-ujhKqutt3f0-unsplash_2_je4yff.png"
                    }
