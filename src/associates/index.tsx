...
const BecomeAssociate = () => {
  return (
    <>
      ...
      <Box sx={{ width: "100vw" }}>
        <PageBanner
          title="Become a Paragone Associate"
          breadcrumbs={[
            { label: "Home", href: "/" },
            { label: "Become a Paragone Associate" },
          ]}
        />
        ...
        <Container maxWidth="lg" sx={{ py: 5 }}>
          ...
          >
            <Grid container spacing={2} alignItems="center">
              ...
              >
                <a href="#join-form">
                  <CustomButton sx={{ width: 160 }}>Join Us</CustomButton>
                </a>
              </Grid>
            </Grid>
          </Box>
            ...
            <Grid item xs={12} md={8}>
              <AnimatedWrapper>
                ...
                <Typography variant="body1" color="text.secondary" paragraph>
                  We strive to ensure that we offer you not just a variety of
                  property listings to aid your sales, but we also ensure the
                  verification of all property listings, enabling you to present
                  your clients with the best offers to choose from. By joining
                  our team, you will have access to an exclusive portfolio of
                  verified properties, giving you a competitive edge in the
                  market. We are dedicated to supporting your success by
                  providing you with the resources, tools, and opportunities you
                  need to excel in your real estate career.
                </Typography>
                ...
                <Box sx={{ mt: 2 }}>
                  ...
                  <Typography variant="body1" color="text.secondary" paragraph>
                    Our team is dedicated to your success through ongoing
                    training, mentorship, and comprehensive resources. We
                    provide you with the tools and knowledge needed to excel in
                    real estate, ensuring you can close transactions seamlessly
                    and grow your career effectively.
                  </Typography>
                  ...
                  <Typography variant="body1" color="text.secondary">
                    Leverage our established brand and marketing resources,
                    including targeted campaigns, personalized materials, and a
                    strong online presence, to attract clients and properties.
                    Our comprehensive support enhances your visibility, builds
                    your reputation, and gives you a competitive edge.
                  </Typography>
                </Box>
              </AnimatedWrapper>
            </Grid>
          ...
          <Box
            sx={{
              ...
              borderRadius: 2,
              backgroundImage:
                "url(https://res.cloudinary.com/dv0mdoa6b/image/upload/v1741882231/paul-edesemi-niElH29LKjw-unsplash_1_acbsao.png)",
              backgroundSize: "cover",
              backgroundPosition: "center",
              position: "relative",
              "&::before": {
          ...
          >
            ...
            >
              ...
              <a href="#join-form">
                <CustomButton sx={{ mt: 2, width: 150 }}>Join now</CustomButton>
              </a>
            </Box>
          </Box>
          <Grid
            ...
            <Grid item xs={12} sm={7}>
              <AnimatedWrapper>
                ...
                <Typography variant="body1" paragraph>
                  ...
                  desires—no matter how ambitious they are!
                </Typography>
                <a href="#join-form">
          ...
          <Grid
            ...
            spacing={6}
            alignItems="center"
            sx={{ my: 4, postion: "relative", zIndex: 10 }}
          >
            ...
            <Grid item xs={12} md={7} sx={{ postion: "relative", zIndex: 99 }}>
              <AnimatedWrapper>
                ...
                <Typography variant="body1" paragraph>
                  Working with like-minded people is a no-brainer because doing
                  so helps you work smarter and engage the power of leverage. It
                  increases your chances for success with a greater probability
                  of achieving your desires. You also connect for beneficial
                  resources and have access to coaches and mentors within the
                  real estate space who can offer that handholding experience as
          ...
          >
            <Grid item xs={12} md={7} sx={{ postion: "relative", zIndex: 10 }}>
              <AnimatedWrapper>
                ...
                <Typography variant="body1" paragraph>
                  Connect with a vast network of industry professionals and
                  peers, sharing valuable insights, collaborating on projects,
                  and expanding your business. Leverage these connections to
                  enhance your knowledge, stay ahead of trends, and drive your
                  real estate success.
                </Typography>
                <a href="#join-form">
                  <CustomButton sx={{ mt: 1, width: 160, py: 1 }}>
        ...
        >
          <Container maxWidth="md">
            ...
            >
              If you got this far, it means you're excited. And so are we. Let's
              set up your one-on-one conversation and start shaping the future
